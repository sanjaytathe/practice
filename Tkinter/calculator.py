...
btnsub=Button(root,text="-",font=("Ariel",12,"bold"),bd=12,height=2,width=6,command=lambda:btnclick("-"))
...
btnmul=Button(root,text="*",font=("Ariel",12,"bold"),bd=12,height=2,width=6,command=lambda:btnclick("*"))
btnmul.grid(row=3,column=3)

btncan=Button(root,text="c",font=("Ariel",12,"bold"),bd=12,height=2,width=6,command=btncan)
btncan.grid(row=4,column=0)
...
btneq=Button(root,text="=",font=("Ariel",12,"bold"),bd=12,height=2,width=6,command=btneq)
